...
class WidgetSizeObserver extends SingleChildRenderObjectWidget {
  const WidgetSizeObserver({ super.key, required this.onSizeChanged, this.offstage = false, super.child});
  ...
  SizeObserverRenderBox createRenderObject(BuildContext context) {
    return SizeObserverRenderBox(onSizeChanged: onSizeChanged, offstage: offstage);
  }

  @override
  void updateRenderObject(BuildContext context, covariant SizeObserverRenderBox renderObject) {
